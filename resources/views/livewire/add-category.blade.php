...
<div>
    ...
    <form wire:submit.prevent="store">
        <div class="mb-4">
            ...
            <input wire:model="categoryName" type="text" id="categoryName" name="categoryName" class="p-2 border rounded-md w-full @error('categoryName') border-red-500 @enderror">
            @error('categoryName')
